...
/**
 * Class Legal_Policy_Image
 *
 * Handles the Images legal page and associated shortcode.
 *
...
class Legal_Policy_Image
{
    ...
    /**
     * Initializes and prints the Images legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-image-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-images" shortcode.
     *
     * @return string The HTML output of the Images legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('image_policy');
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-images', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
