...
/**
 * Class Legal_Policy_Refund
 *
 * Handles the Refund Policy legal page and associated shortcode.
 *
...
class Legal_Policy_Refund
{
    ...
    /**
     * Initializes and prints the Refund Policy legal page content via
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-refund-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-refund" shortcode.
     *
     * @return string The HTML output of the Refund legal legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('return_policy');
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-refund', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
