...
/**
 * Class Legal_Policy_Copyright
 *
 * Handles the Copyright legal page and associated shortcode.
 *
...
class Legal_Policy_Copyright
{
    ...
    /**
     * Initializes and prints the Copyright legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-copyright-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-copyright" shortcode.
     *
     * @return string The HTML output of the Copyright legal
     *                page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('copyright_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'copyright-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-copyright', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
