...
/**
 * Class Legal_Policy_Terms_Conditions
 *
 * Handles the Terms and Conditions legal page and associated shortcode.
 *
...
class Legal_Policy_Terms_Conditions
{
    ...
    /**
     * Initializes and prints the Terms and Conditions Policy legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-terms-and-conditions-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-terms-and-conditions" shortcode.
     *
     * @return string The HTML output of the Terms and Conditios legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('terms_and_conditions_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'terms-and-conditions-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-terms-conditions', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
