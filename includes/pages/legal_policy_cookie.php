...
/**
 * Class Legal_Policy_Cookie
 *
 * Handles the Cookie Policy legal page and associated shortcode.
 *
...
class Legal_Policy_Cookie
{
    ...
    /**
     * Initializes and prints the Cookie Policy legal page content via
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-cookie-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-cookie" shortcode.
     *
     * @return string The HTML output of the Cookie legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('cookie_policy');
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-cookie', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
