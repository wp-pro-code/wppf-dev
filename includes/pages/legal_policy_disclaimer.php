...
/**
 * Class Legal_Policy_Disclaimer
 *
 * Handles the Disclaimer legal page and associated shortcode.
 *
...
class Legal_Policy_Disclaimer
{
    ...
    /**
     * Initializes and prints the Disclaimer Policy legal page content via
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-disclaimer-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-disclaimer" shortcode.
     *
     * @return string The HTML output of the Disclaimer legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('disclaimer_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'disclaimer-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-disclaimer', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
