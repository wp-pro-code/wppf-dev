...
/**
 * Class Legal_Policy_Acceptable_Use
 *
 * Handles the Acceptable Use Policy legal page and associated shortcode.
 *
...
class Legal_Policy_Acceptable_Use
{
    ...
    /**
     * Initializes and prints the Acceptable Use legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-acceptable-use-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-acceptable-use" shortcode.
     *
     * @return string The HTML output of the Acceptable Use legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('acceptable_use_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'acceptable-use-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-acceptable-use', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
