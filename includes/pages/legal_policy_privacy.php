...
/**
 * Class Legal_Policy_Privacy
 *
 * Handles the Privacy Policy page and associated shortcode.
 *
...
class Legal_Policy_Privacy
{
    ...
    /**
     * Initializes and prints the Privacy Policy legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-privacy-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-privcy-policy" shortcode.
     *
     * @return string The HTML output of the Privacy Policy legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('privacy_policy');
        ...
        $menu_args = wp_nav_menu(
            [
                'menu'                 => 4,
                'menu_class'           => 'px-2 text-xxs',
                'container'            => 'nav',
                'container_class'      => '',
                'container_id'         => '',
                'container_aria_label' => __('Navagation links to Privacy legal policy.', 'wppf'),
                'before'               => '',
                'after'                => '',
                'link_before'          => '',
                'link_after'           => '',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-privacy', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
