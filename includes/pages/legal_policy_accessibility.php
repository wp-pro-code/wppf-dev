...
/**
 * Class Legal_Policy_Accessibility
 *
 * Handles the Accessibility Policy legal page and associated shortcode.
 *
...
class Legal_Policy_Accessibility
{
    ...
    /**
     * Initializes and prints the End User Agreement legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-accessibility-statement', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-accessibility" shortcode.
     *
     * @return string The HTML output of the Accessibility Policy legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('accessibility_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'accessibility-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-accessibility', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
