...
/**
 * Class Legal_Policy_Logo
 *
 * Handles the Logos and Images Protection legal page and associated shortcode.
 *
...
class Legal_Policy_Logo
{
    ...
    /**
     * Initializes and prints the and Images Protection legal page
    ...
    public static function init($name_tm, $admin, $legal_strings): void
    {
        ...
        $shortcode_framework->registerShortcode('getpage-legal-logo-policy', [self::class, 'callback']);
        $shortcode_framework->init();
    }

    /**
     * Callback function for the "get-legal-logos-images-protection" shortcode.
     *
     * @return string The HTML output of the get-legal-logos-images-protection
     *                legal page.
     */
    public static function callback(): string
    {
        ...
        $svg_item_logo_policy = $svg_framework->get_svg('logo_policy');
        ...
        $template_args = [
            ...
            [
                ...
                'section_class' => 'logo-and-images-protection-policy',
        ...
        ob_start();
        echo \WPP\WPPF\Helpers\Get_Template::part(['slug' => 'partials/legal-policy-logos-and-images', 'name' => 'view', 'args' => $template_args]);
        return ob_get_clean();
    }
}
